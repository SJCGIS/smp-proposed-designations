...
L.App.ClusteredCentroidLayer = L.esri.Layers.FeatureManager.extend({
  statics: {
  ...
  initialize: function (options) {
    L.esri.Layers.FeatureManager.prototype.initialize.call(this, options);
    ...
    this.cluster.on(L.App.ClusteredCentroidLayer.EVENTS, this._propagateEvent, this);
    this.cluster.on(L.App.ClusteredCentroidLayer.CLUSTEREVENTS, this._propagateClusterEvent, this);
  },
  ...
  createLayers: function(features){
    ...
    for (var i = features.length - 1; i >= 0; i--) {
      var centroid = turfcentroid(features[i]);
